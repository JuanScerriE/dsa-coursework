...
def find_products(a):
    ...
    # unique products. This takes into account the commutativity
    # of multiplications so we do not have doubles. Moreover,
    # the time complexity of this is O(n(n-1)/2). This is the exact
    # amount of iterations. We keep track of the previous elements
    # to make sure that we do not repeat elements. Both in the outer loop
    # and the inner loop.
    for i in range(len(a) - 1):
        if prev_outer < a[i] or i == 0:
            ...
            # This is by providing an example, in the code.
    ...
    # the different elements without actually implementing any checks.
