...
attempted, and their solutions have been tested and confirmed to
work well without any bugs. %(see list below).
...
Python 3. The main reason for chosing Python 3 is the speed of
development.
